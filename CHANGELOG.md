...
- Ra mắt Vietflex trên nền Leaflet 2.0.0-alpha.1.
- Thêm preset Việt Nam–Biển Đông, cờ Việt Nam và ghim mặc định mới.
- Thêm Google Map Tiles API chính thức với `vi`/`VN`.
- Thêm endpoint Google tương thích dưới dạng lựa chọn chủ động.
- Giữ nguyên giấy phép BSD của lõi Leaflet; phần Vietflex dùng MIT.
